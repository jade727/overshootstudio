...
<head>
  ...
  <link rel="shortcut icon" href="favicon.ico" type="image/x-icon">
    ...
    <link rel="stylesheet" type="text/css" href="./themes/pmahomme/css/theme.css?v=5.1.3&nocache=2232739880ltr&server=1">
...
<body>
    <div id="pma_navigation" data-config-navigation-width="324">
  ...
  <div class="pma_quick_warp"><div class="drop_list"><button title="Recent tables" class="drop_button btn">Recent</button><ul id="pma_recent_list"><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=photoshoot&table=walkin">`photoshoot`.`walkin`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=photoshoot&table=users">`photoshoot`.`users`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=db_new_barangay&table=user_info">`db_new_barangay`.`user_info`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=db_new_barangay&table=businesses">`db_new_barangay`.`businesses`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=db_new_barangay&table=curfews">`db_new_barangay`.`curfews`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=db_new_barangay&table=resident_complaints">`db_new_barangay`.`resident_complaints`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=db_new_barangay&table=users">`db_new_barangay`.`users`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=db_new_barangay&table=multiple_doc_uploads">`db_new_barangay`.`multiple_doc_uploads`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=db_new_barangay&table=request_business_clearance">`db_new_barangay`.`request_business_clearance`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=db_new_barangay&table=request_job_seekers">`db_new_barangay`.`request_job_seekers`</a></li></ul></div><div class="drop_list"><button title="Favorite tables" class="drop_button btn">Favorites</button><ul id="pma_favorite_list"><li class="warp_link">There are no favorite tables.</li></ul></div><div class="clearfloat"></div></div>
...
<div id='pma_navigation_tree_content'>
  ...
  <input type="hidden" name="tab_hash" value="">
    ...
    <input type="hidden" name="token" value="214c33777d5b3d7c6a5c56577e287664">
...
</span><small>Set to 0 to collapse navigation panel.</small></th><td><input type="number" name="NavigationWidth" id="NavigationWidth" class="custom" value="324"><a class="restore-default hide" href="#NavigationWidth" title="Restore default value"><img src="themes/dot.gif" title="" alt="" class="icon ic_s_reload"></a></td></tr></table>
</fieldset>
    ...
    <div id="pma_console">
                ...
                <div class="message welcome">
                    ...
                    <span class="hide" id="instructions-1">
                        Press Enter to execute query                    </span>
                            ...
                            targetdb="photoshoot" targettable="users">
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `users`</span>
                                            ...
                                            <div class="message history collapsed hide select"
                            targetdb="photoshoot" targettable="walkin">
                            <div class="action_content">
                    <span class="action collapse">
            Collapse
                    </span>
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `walkin`</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="photoshoot" targettable="walkin">
                            <div class="action_content">
